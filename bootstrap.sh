...
echo ""
echo -e "${YELLOW}🛡️  Security Analysis:${NC}"
echo "   python search_langflow.py           # Comprehensive LangFlow detection (packages + manual)"
echo "   python search_langflow.py -v        # Verbose analysis with detection breakdown"
echo ""
